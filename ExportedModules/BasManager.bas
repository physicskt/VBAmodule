...
Sub ImportAllModules(importPath As String)
    ...
    Do While fileName <> ""
        ...
        ' Only import .bas, .cls, and .frm files
        If fileExt = EXT_BAS Or fileExt = EXT_CLS Or fileExt = EXT_FRM Then
...
Sub ImportSingleModule(fullPath As String, existingModules As Object)
    ...
    ' TODO: Add option for overwriting existing modules in future versions
